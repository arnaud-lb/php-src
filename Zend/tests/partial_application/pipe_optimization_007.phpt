--TEST--
Partial application pipe optimization: PFA with multiple placeholders can not be optimized
--EXTENSIONS--
opcache
--INI--
...
0009 T1 = CALLABLE_CONVERT_PARTIAL
...
0000 CV0($a) = RECV 1
0001 CV1($b) = RECV 2
0002 INIT_FCALL 2 112 string("var_dump")
0003 SEND_VAR CV0($a) 1
0004 SEND_VAR CV1($b) 2
0005 DO_ICALL
0006 RETURN null
not enough arguments for application of foo, 1 given and exactly 2 expected, declared in %s on line %d
