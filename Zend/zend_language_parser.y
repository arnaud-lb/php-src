...
%type <ast> echo_expr_list unset_variables catch_name_list catch_list optional_variable optional_using_as_variable parameter_list class_statement_list
...
reserved_non_modifiers:
	...
	| T_CLASS_C | T_TRAIT_C | T_FUNC_C | T_METHOD_C | T_LINE | T_FILE | T_DIR | T_NS_C | T_FN | T_MATCH | T_ENUM | T_USING
	| T_PROPERTY_C
;
