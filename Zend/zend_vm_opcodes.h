...
# define ZEND_OPCODE_HANDLER_CCONV_EX ZEND_PRESERVE_NONE
...
typedef const struct _zend_op *(ZEND_OPCODE_HANDLER_CCONV *zend_vm_opcode_handler_reg_t)(struct _zend_execute_data *execute_data, const struct _zend_op *opline, zval reg);
...
#define ZEND_VM_OP_SPEC_MASK     0x000001ff
#define ZEND_VM_OP_CONST         0x00000002
#define ZEND_VM_OP_TMP           0x00000004
#define ZEND_VM_OP_VAR           0x00000008
#define ZEND_VM_OP_UNUSED        0x00000010
#define ZEND_VM_OP_CV            0x00000020
#define ZEND_VM_OP_TMPVAR        0x00000040
#define ZEND_VM_OP_TMPVARCV      0x00000080
#define ZEND_VM_OP_REG           0x00000100
...
#define ZEND_VM_EXT_RETVAL_REG   (UINT64_C(0x00008000) << 32)
