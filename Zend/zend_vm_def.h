...
ZEND_VM_HANDLER(210, ZEND_SEND_PLACEHOLDER, UNUSED, UNUSED)
{
	USE_OPLINE
	zval *arg;
	zend_execute_data *call = EX(call);
...
ZEND_VM_HANDLER(211, ZEND_DO_FCALL_PARTIAL, ANY, ANY)
{
	USE_OPLINE
	zend_execute_data *call = EX(call);
	zval *result = NULL;
...
ZEND_VM_HANDLER(212, ZEND_CHECK_PARTIAL_ARGS, UNUSED, UNUSED)
{
	USE_OPLINE
	zend_execute_data *call = EX(call);
