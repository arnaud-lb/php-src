 ...
 * Stub hash: e7883aeef6def3c838a6065970d1168920368050 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_ReflectionProperty_getRawValueWithoutLazyInitialization, 0, 1, IS_MIXED, 0)
	ZEND_ARG_TYPE_INFO(0, object, IS_OBJECT, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(1, hasValue, IS_MIXED, 0, "null")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_ReflectionProperty_getRawValueWithoutLazyInitializationTuple, 0, 1, IS_ARRAY, 0)
	ZEND_ARG_TYPE_INFO(0, object, IS_OBJECT, 0)
ZEND_END_ARG_INFO()
...
static const zend_function_entry class_ReflectionProperty_methods[] = {
	...
	ZEND_ME(ReflectionProperty, getRawValueWithoutLazyInitializationTuple, arginfo_class_ReflectionProperty_getRawValueWithoutLazyInitializationTuple, ZEND_ACC_PUBLIC)
